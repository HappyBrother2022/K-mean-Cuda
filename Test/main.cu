...
void CPU_k_mean() {
	...
	//for calculating the closest centriod for the given set of data , centiods and number of centers
...
void GPU_k_mean() {
	...
	//	Code for measuring was taken from http://www.informit.com/articles/article.aspx?p=1881386&seqNum=2
	//  Beginning
	//timer : calculation of GPU timer of the process
	////
	std::chrono::time_point<std::chrono::system_clock> start, end;
	std::chrono::duration<double> elapsed_seconds;
	std::time_t end_time;
